...
namespace DieRoller.ViewModels
{
    public class ShellViewModel : Conductor<object>
    {
        ...
        private static PlayerCharacter _Player = new PlayerCharacter();
        ...
        private int _finalAbilityScoreStr = 10;
        private int _finalAbilityScoreDex = 10;
        private int _finalAbilityScoreCon = 10;
        private int _finalAbilityScoreInt = 10;
        private int _finalAbilityScoreWis = 10;
        private int _finalAbilityScoreCha = 10;

        //private variables for storeing Ability Scores
        private int _abilityScore1 = _Player.AbilityScoresRaw[4];
        private int _abilityScore2 = _Player.AbilityScoresRaw[2];
        private int _abilityScore3 = _Player.AbilityScoresRaw[1];
        private int _abilityScore4 = _Player.AbilityScoresRaw[3];
        private int _abilityScore5 = _Player.AbilityScoresRaw[5];
        private int _abilityScore6 = _Player.AbilityScoresRaw[0];

        //Private variables for holding final Ability Score Bonus Mods
        private int _textBoxFinalModStr;
        private int _textBoxFinalModDex;
        private int _textBoxFinalModCon;
        private int _textBoxFinalModInt;
        private int _textBoxFinalModWis;
        private int _textBoxFinalModCha;
        ...
        public void FinalCommit()
        {
            ...
            {
                //Finds the index of ability score name and assigns the aproprate value of adjustable 
                //ablilty scores to the aproprate final ability score array.  
        ...
        public void Clear()
        {
            //Set model and Final Scores to 10
            FinalAbilityScoreCha = 10;
            FinalAbilityScoreCon = 10;
            FinalAbilityScoreDex = 10;
            FinalAbilityScoreInt = 10;
            FinalAbilityScoreStr = 10;
            FinalAbilityScoreWis = 10;
